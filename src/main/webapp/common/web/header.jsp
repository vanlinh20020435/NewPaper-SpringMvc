<%@ page import="com.vanlinh.util.SecurityUtils" %>
                    ...
                    <div class="col-lg-4 hidden-md-down">
                        <div class="topmenu text-center">
                            ...
                            <security:authorize access = "isAnonymous()">
                                <li class="list-inline-item"><a href="<c:url value='/dang-nhap'/>"><i class="fa fa-star"></i> Đăng nhập</a></li>
                                <li class="list-inline-item"><a href="<c:url value='/dang-ky'/>"><i class="fa fa-bolt"></i> Đăng ký</a></li>
                            </security:authorize>
                            <security:authorize access = "isAuthenticated()">
								<li class="list-inline-item"><a href="#">Wellcome, <%=SecurityUtils.getPrincipal().getFullName()%></a></li>
								<li class="list-inline-item"><a  href="<c:url value='/thoat'/>">Thoát</a></li>
						    </security:authorize>
                            </ul><!-- end ul -->
                        </div><!-- end topmenu -->
                    </div><!-- end col -->
        ...
        <div class="header-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="index.html"><img src="<c:url value='/template/web/images/flogo.png'/>" alt=""></a>
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
            </div><!-- end header-logo -->
                                                            ...
                                                            <div class="blog-box">
                                                                <div class="post-media">
                                                                    <a href="single.html" title="">
                                                                        <img src="<c:url value='/template/web/upload/vietnam.jpg'/>" alt="" class="img-fluid">
